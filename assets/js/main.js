...
$(document).ready(function () {
    ...
    if ($('#instaFeed-style1').length != 0) {
        ...
        var token = 'IGQVJXMHNjNFhmV3RXOG5ocHpKRmttaDFxeWpaTGJ2UVZA0X2VPS1lpazBVTzZAPaXNFOThGRGhQSFFmYWxlYjk3RVdna25BWkNiWG11WVJsWFBVSFc5T0p5Y0R1dnZAET1FlSngzUW9vbkJuVmJucmR1QgZDZD';
    ...
    if ($('#instaFeed-aside').length != 0) {
        ...
        var token = 'IGQVJWN1pHaUZA4eEoxa3hKWTZA2VkR3N3hGMENLcjFKRGp2TVE4bENTX3N0RllmY2FDNDRSV1VSQmx0ejhPLWtBNXVuaFdtVkFNQmdGQVNpamNiQlJTZA2lFS01Mc1JseWxWLVlrbEdiZAXhrWTJUNHlSZAAZDZD'; // learn how to obtain it below
